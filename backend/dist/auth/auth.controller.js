...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'admin123', description: 'Contraseña de acceso' }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)(),
    __metadata("design:type", String)
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Sesión exitosa, retorna token JWT con validez de 30 minutos.' }),
